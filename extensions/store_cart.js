...
$tag.button({icons: {primary: "ui-icon-closethick"},text: true});/*QOS*/
...
/*QualityOverstock*/	$modal.dialog({modal: true,width:'80%',height:$(window).height() - 110});  //browser doesn't like percentage for height
						}
